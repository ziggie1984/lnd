...
// least lnwire.MaxMsgBody so that a single max-sized wire message can
// always fit in the token bucket — otherwise rate.Limiter.AllowN would
// reject every call and silently disable onion message forwarding.

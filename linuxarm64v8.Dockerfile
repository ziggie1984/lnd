FROM golang:1.20.3-stretch as builder
...
# Build loop binary
RUN git clone --depth 1 --branch v0.22.0-beta https://github.com/lightninglabs/loop.git /go/src/github.com/lightninglabs/loop

...
type SignMessageWithAddrRequest struct {
	...
	// The address which will be used to lookup the private key and sign the
...
type VerifyMessageWithAddrRequest struct {
	...
	// The address which will be used to lookup the public key and verify the
	// the signature
...
func (x *VerifyMessageWithAddrResponse) GetPubkey() string {
	if x != nil {
		return x.Pubkey
	}
	return ""
...
var file_walletrpc_walletkit_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x70, 0x75, 0x62, 0x6b, 0x65, 0x79, 0x22, 0xe4,

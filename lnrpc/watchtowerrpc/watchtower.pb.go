...
func file_watchtowerrpc_watchtower_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_watchtowerrpc_watchtower_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_watchtowerrpc_watchtower_proto_msgTypes[1].Exporter = func(v any, i int) any {

...
type SqliteConfig struct {
	...
	TxLevelLock    bool          `long:"txlevellocking" description:"Use a Go-level mutex to serialize write transactions, preventing SQLITE_BUSY errors from concurrent writers. Useful on resource-constrained devices."`

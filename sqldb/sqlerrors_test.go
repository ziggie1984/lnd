...
// TestSqliteUniqueConstraintConstants verifies that the SQLite library
// constants for unique constraint violations have the expected integer values.
// Like TestSqliteErrorCodeConstants, this guards against upstream changes.
func TestSqliteUniqueConstraintConstants(t *testing.T) {
	t.Parallel()
